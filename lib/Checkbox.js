...
export default class Checkbox extends Component {
    ...
    static propTypes = {
        ...
        styles: PropTypes.shape({
            ...
            labelContainer: View.propTypes.style,
    ...
    render() {
        const { theme, primary, checked, disabled, styles, value, onCheck } = this.props;
        ...
        return (
            ...
            >
                <View style={[componentStyles.container, styles.container]}>
                    ...
                    <View
                        style={[componentStyles.labelContainer, styles.labelContainer]}
