...
export default class IconToggle extends Component {
    ...
    render() {
        ...
        const { color, onLayout, children, accessibilityLabel } = this.props;
        ...
        return (
            <View {...this._responder} accessible accessibilityComponentType='button' accessibilityTraits='button' accessibilityLabel={accessibilityLabel} onLayout={onLayout}>
                <View>
                    {size &&
                        <Animated.View
                            style={[{
